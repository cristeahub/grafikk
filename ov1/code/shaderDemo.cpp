...
GLuint setupShaders() {
	...
	shader.setVertexAttribName(VSShaderLib::VERTEX_COLOR_ATTRIB, "color");
...
void initOpenGL()
{
	...
	glBindBuffer(GL_ARRAY_BUFFER, buffers[4]); // Bind our second Vertex Buffer Object  
	...
	glEnableVertexAttribArray(VSShaderLib::VERTEX_COLOR_ATTRIB); // Enable the second vertex attribute array
	glVertexAttribPointer(VSShaderLib::VERTEX_COLOR_ATTRIB, 4, GL_FLOAT, GL_FALSE, 0, 0); // Set up our vertex attributes pointer  
...
//  GLUT initialization
	...
	glutCreateWindow("Hello Wolrd-GLSL Demo");
